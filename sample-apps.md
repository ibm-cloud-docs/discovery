...
[Understanding Customer Feedback App  ![External link icon](../../icons/launch-glyph.svg "External link icon")](https://developer.ibm.com/code/patterns/get-customer-insights-from-product-reviews/){: new_window}
...
[Cognitive Search Web App  ![External link icon](../../icons/launch-glyph.svg "External link icon")](https://developer.ibm.com/code/patterns/create-an-app-to-perform-intelligent-searches-on-data/){: new_window}
...
[Mine Enterprise Data for Insights  ![External link icon](../../icons/launch-glyph.svg "External link icon")](https://developer.ibm.com/code/journey/import-enrich-and-gain-insight-from-data/){: new_window}
...
[Cognitive News Alerting App   ![External link icon](../../icons/launch-glyph.svg "External link icon")](https://developer.ibm.com/code/journey/create-cognitive-news-alerting-app/){: new_window}
...
[Cognitive Retail Chatbot  ![External link icon](../../icons/launch-glyph.svg "External link icon")](https://developer.ibm.com/code/journeys/create-cognitive-retail-chatbot/){: new_window}
...
[Cognitive News Search App  ![External link icon](../../icons/launch-glyph.svg "External link icon")](https://developer.ibm.com/code/journey/create-a-cognitive-news-search-app/){: new_window}
...
[Stock Advisor App  ![External link icon](../../icons/launch-glyph.svg "External link icon")](https://developer.ibm.com/code/patterns/create-a-web-app-to-get-stock-information-prices-and-sentiment/){: new_window}
...
[Mobile App Insights Sample App  ![External link icon](../../icons/launch-glyph.svg "External link icon")](https://www.ibm.com/developerworks/library/cc-build-app-analysis-mobile-app-bluemix-watson-discovery-cloudant/index.html){: new_window}
...
[Discovery Lab  ![External link icon](../../icons/launch-glyph.svg "External link icon")](https://developer.ibm.com/code/labs/#!/lab/Watson-Discovery-Lab){: new_window}
In this lab, you will create a private collection in the Discovery service and learn how to query the collection.

[Discovery News Lab  ![External link icon](../../icons/launch-glyph.svg "External link icon")](https://developer.ibm.com/code/labs/#!/lab/Watson-Discovery-News-Lab){: new_window}
