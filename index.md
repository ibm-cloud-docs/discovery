...
This documentation applies to {{site.data.keyword.discoveryshort}} service instances that you create with a Lite or Advanced plan, or that you created with a Premium plan before 16 July 2020. For more information about features in Premium plan instances that were created after that date, see [these docs](https://cloud.ibm.com/docs/discovery-data?topic=discovery-data-about){: external}.
{: important}
